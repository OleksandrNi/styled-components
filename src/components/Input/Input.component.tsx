...
export const InputComponent: React.FC<InputProps> = ({
  type = 'text', label, error = '', size = 'M', placeholder
}) => {
    ...
    <>
      <div className={inputClass}>
        ...
        <div className={styles.icon} onClick={isVisiblePassword}>
          {type === 'password' && <img src="./icons/common/eye.svg" alt="eye" />}
          {type === 'currency' && <img src="./icons/common/currency.svg" alt="currency" />}
        </div>
      </div>
